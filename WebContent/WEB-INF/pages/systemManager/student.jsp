...
<head>
	    ...
	    table = $('#data_list').DataTable({
			...
			"fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
				if(aData.success=="查询成功"){
					alert(aData.success);
					modelSno=aData.sno;
					modelSname=aData.sname;
				}else{
					alert("请输入学号以及对应的学生姓名！");
				}
	        },
	    	
	    	"ajax": {
	            "url": "/Library/systemModule/stuQuery",
	            "type": "POST",
	            "data": function (d) {
	                return {
	                    "sno": $('#query_sno').val(),
	...
	function add() {
	    ...
	    jQuery.ajax({
	        type: 'POST',
	        url: '/Library/systemModule/stuAdd',
	        cache: false,
	        data: param,
	...
	function showUpdate() {
		$('#update_sno').val(modelSno);
		$('#update_sname').val(modelSname);
	...
	function update() {
		...
		jQuery.ajax({
	        type: 'POST',
	        url: '/Library/systemModule/stuUpdate',
	        cache: false,
	        data: param,
	        success: function (data) {
	        	if(data==true){
	...
	function del() {
	    jQuery.ajax({
	        type: 'POST',
	        url: '/Library/systemModule/stuDelete',
	        cache: false,
	        data: {
	            id: modelSno
	        },
                    ...
                    <form class="form-horizontal" id="form_add">
                        <div class="row">
                            <div class="col-lg-12 form-group">
                                <label class="col-lg-3 control-label" for="add_sno">*&nbsp;学号</label>
                                <div class="col-lg-9">
                        ...
                        <div class="row">
                            <div class="col-lg-12 form-group has">
                                <label class="col-lg-3 control-label" for="add_sname">*&nbsp;姓名</label>
                                <div class="col-lg-9">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form class="form-horizontal" id="form_update">
                        ...
                        <div class="row">
                            <div class="col-lg-12 form-group">
                                <label class="col-lg-3 control-label" for="update_sno">*&nbsp;学号</label>
                                <div class="col-lg-9">
